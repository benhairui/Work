...
public class SimHashTest {
    ...
    public static void main(String[] args) {
        SimHashTest simhashAlgoService = new SimHashTest();
...
//        System.out.println(b1.and(b2));
        ...
        String s1 = "1具体分析如下： （1）锂电池产业的高速发展，为锂电设备制造业带来了巨大的市场空间 1）全球锂电池行业发展情况 近年来，随着新能源汽车产业的快速发展，以及 3C数码领域的持续稳定发展，加之具有万亿级别规模的储能市场起步，带动对锂电池的需求，全球锂电池产量保持 25%以上的速度增长。";
//        String s2 = "具体分析如下： （1）锂电池产业的高速发展，为锂电设备制造业带来了巨大的市场空间 1）全球锂电池行业发展情况 近年来，随着新能源汽车产业的快速发展，以及 3C数码领域的持续稳定发展，加之具有万亿级别规模的储能市场起步，带动对锂电池的需求，全球锂电池产量保持 25%以上的速度增长。 (:储能_下游:锂电池_中游:锂电池_中游)";
        String s2 = "2具体分析如下： （1）锂电池产业的高速发展，为锂电设备制造业带来了巨大的市场空间 1）全球锂电池行业发展情况 近年来，随着新能源汽车产业的快速发展，以及 3C数码领域的持续稳定发展，加之具有万亿级别规模的储能市场起步，带动对锂电池的需求，全球锂电池产量保持 25%以上的速度增长。";
        SimHashTest h1 = new SimHashTest();
        SimHashTest h2 = new SimHashTest();
        h1.simHash(s1,64);
        h2.simHash(s2,64);

        System.out.println(h1.strSimHash);



        System.out.println("hell oworld");
        System.out.println(simhashAlgoService.getDistance(h1.strSimHash,h2.strSimHash));
...
//             过滤超频词
    ...
    public List subByDistance(SimHashTest Simhash, int distance) {
        // 分成几组来检查
